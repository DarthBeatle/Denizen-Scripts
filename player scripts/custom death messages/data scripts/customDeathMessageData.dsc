Custom_Death_Message_Data:
    ...
    creeper:
        - <gray><player.name> went out with a bang!
        - <gray><player.name> hugged a creeper
        - <gray><player.name> did not hear the SSSsss
        - <gray><player.name> doesn't believe in shields
    enderman:
        - <gray><player.name> got berried by an enderman
        - <gray><player.name> incurred the wrath of the elder gods and lost
        - <gray><player.name> lost a staring contest
        - <gray><player.name> tried to hug an enderman
    endermite:
        - <gray><player.name> was annoyed to death by an endermite
        - <gray><player.name> was slain by the lowly endermite
        - <gray><player.name> spawned an endermite and it killed them
    skeleton:
    ...
    slime:
        - <gray><player.name> was slain by slime, and embarrassment as well
        - <gray><player.name> got slimed
        - <gray><player.name> is an embarrassment to the server
        - <gray><player.name> has no clue what they are doing
        - <gray>The lowly slime has slain <player.name>. Oh how the mighty have fallen!
    spider:
        - <gray><player.name> was killed by an itsy bitsy spider
    spider_jockey:
    ...
    zombified_piglin:
        - <gray><player.name> was hunted down by a zombified piglin
    zombie_villager:
        - <gray><player.name> would not leave the zombie villager alone